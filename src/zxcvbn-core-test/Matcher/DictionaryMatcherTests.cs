...
{
    private readonly DictionaryMatcher matcher1 = new("d1", "test_dictionary_1.txt");
    private readonly DictionaryMatcher matcher2 = new("d2", "test_dictionary_2.txt");
    private readonly DictionaryMatcher matcherTv = new("us_tv_and_film", "us_tv_and_film.lst");
