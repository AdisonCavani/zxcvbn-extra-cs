...
public class DateMatcherTests
{
    ...
    public void DateMatcherMatchesDateWithVariedElementOrder(string order)
    {
        ...
        var password = order.Replace("d", day.ToString(CultureInfo.CurrentCulture))
            .Replace("m", month.ToString(CultureInfo.CurrentCulture)).Replace("y", year.ToString(CultureInfo.CurrentCulture));
